...
from data_loaders.tensors import t2m_collate, motionx_collate
...
def get_collate_fn(name, hml_mode='train'):
    ...
    return COLLATE_FNS.get(name,all_collate)
...
def get_dataset(name, num_frames, split='train', hml_mode='train')->Dataset:
    ...
    if name in ["humanml", "kit", "motionx"]:
